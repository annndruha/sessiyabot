...
answer = {
    ...
    # Greetings
    'начать' : 'Привет!\nЯ могу поддерживать простой диалог\nЕсли ты хочешь узнать мои команды, то напиши: /help\nА если я веду себя странно, то пиши ему в лс: vk.com/annndruha',
    'старт' : 'Привет!\nЯ могу поддерживать простой диалог\nЕсли ты хочешь узнать мои команды, то напиши: /help\nА если я веду себя странно, то пиши ему в лс: vk.com/annndruha',
    'start' : 'Привет!\nЯ могу поддерживать простой диалог\nЕсли ты хочешь узнать мои команды, то напиши: /help\nА если я веду себя странно, то пиши ему в лс: vk.com/annndruha',
    'здравствуй' : 'Привет!\nЯ могу поддерживать простой диалог\nЕсли ты хочешь узнать мои команды, то напиши: /help\nА если я веду себя странно, то пиши ему в лс: vk.com/annndruha',
    'хай' : 'Привет!\nЯ могу поддерживать простой диалог\nЕсли ты хочешь узнать мои команды, то напиши: /help\nА если я веду себя странно, то пиши ему в лс: vk.com/annndruha',
    ...
    'help':'Чтобы узнать когда у тебя сессия, просто набери любое сообщение, содержащее это слово. Если я ошибся, то измени дату функцией ниже:\n\n/change ДД.ММ.ГГГГ\n   -команда корректирует вашу дату начала сессии\n\n/start ЧЧ:ММ\n   -команда, которая активирует ежедневные напоминания в назначенное вами время.\n\n/stop\n    -команда, отключающая ежедневные напоминания.\n\nТак же я умею поддерживать диалог(чуть-чуть) и искать некторые вещи в Википедии, просто наберите интересующее вас слово.',
    '/help':'Чтобы узнать когда у тебя сессия, просто набери любое сообщение, содержащее это слово. Если я ошибся, то измени дату функцией ниже:\n\n/change ДД.ММ.ГГГГ\n   -команда корректирует вашу дату начала сессии\n\n/start ЧЧ:ММ\n   -команда, которая активирует ежедневные напоминания в назначенное вами время.\n\n/stop\n    -команда, отключающая ежедневные напоминания.\n\nТак же я умею поддерживать диалог(чуть-чуть) и искать некторые вещи в Википедии, просто наберите интересующее вас слово.',
    'хэлп':'Чтобы узнать когда у тебя сессия, просто набери любое сообщение, содержащее это слово. Если я ошибся, то измени дату функцией ниже:\n\n/change ДД.ММ.ГГГГ\n   -команда корректирует вашу дату начала сессии\n\n/start ЧЧ:ММ\n   -команда, которая активирует ежедневные напоминания в назначенное вами время.\n\n/stop\n    -команда, отключающая ежедневные напоминания.\n\nТак же я умею поддерживать диалог(чуть-чуть) и искать некторые вещи в Википедии, просто наберите интересующее вас слово.',
...
db_ans = {
    'incorrect_time':'Некорректный формат времени для ежедневных напоминаний, правильный пример:\n/start 07:30',
    ...
    'change_time':'Время напоминаний изменено на:',
    ...
    'change_date':'Дата ближайшего экзамена изменена на:',
    'msk':'мск',
    'forget':'Вас много, я подзабыл...',
    'not_available':'К сожалению, действие временно недоступно'
}
exam_message = {
    'ask_exam_past':'Экзамен позади, надеюсь ты хорошо его сдал!',
    'sessiya_going':'Сессия уже идёт! Ты молодец, я в тебя верю и желаю успеха на экзаменах! &#10084;',
