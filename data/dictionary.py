...
db_ans = {
    ...
    'set_tz':'Временная зона изменена',
    ...
    'msk':'мск',
    'forget':'Я запутался в своих записях...так...',
    'not_available':'К сожалению, действие временно недоступно'
}
exam_message = {
    'ns_time_until_exam':'Вы мне точно не сказали когда, могу предположить что до экзамена:',
    'ns_exam_tomorrow':'Если не ошибаюсь экзамен завтра, ночь перед экзаменом самая важная (выспитесь!)',
    'ns_exam_today':'У вас сегодня экзамен? Угадал?',
    'ns_ask_exam_past':'Экзамен вроде прошёл',
