...
def longpull_loop():
    while True:
        print(f'[{timestamp()}] Longpull loop: Start')
        try:
            ...
            print(f'[{timestamp()}] Longpull loop: Unknown exception')
